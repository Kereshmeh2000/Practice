...
import { HeaderNotifs, HeaderProfile } from './constants';
...
export default function DesktopNav() {
    ...
    return (
        <nav className="z-10 hidden lg:flex items-center justify-around bg-pink-500 text-white px-10 font-bolder">
